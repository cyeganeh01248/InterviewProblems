...
class ProductObj {
  ...
  stock;
  warehouse;
  constructor(id, product_name, price, stock, warehouse) {
    this.id = id;
...
function Products({
  ...
  const [products, setProducts] = import_react.useState([]);
  const [search, setSearch] = import_react.useState("");
  import_react.useEffect(() => {
    fetch("/api/products?" + new URLSearchParams({ search })).then((resp) => resp.json()).then((products2) => {
  ...
  return jsx_dev_runtime.jsxDEV("div", {
    ...
    children: [
      ...
      jsx_dev_runtime.jsxDEV("div", {
        id: "products",
        children: products.map(({ id }, i) => jsx_dev_runtime.jsxDEV(Product, {
          product: id,
          loggedIn,
          color: colors[i],
          setCart
...
function Product({
  ...
  const [clicked, setClicked] = import_react.useState(false);
  const [data, setData] = import_react.useState(new ProductObj(0, "", 0, 0, 0));
  import_react.useEffect(() => {
    fetch(`/api/product/${product}`).then((resp) => resp.json()).then(setData);
  }, []);
  let content;
  if (!clicked)
    content = jsx_dev_runtime.jsxDEV(jsx_dev_runtime.Fragment, {
      children: [
        ...
        jsx_dev_runtime.jsxDEV("h4", {
          children: usdfmt(data.price / 100)
        }, undefined, false, undefined, this)
      ]
    }, undefined, true, undefined, this);
  else
    content = jsx_dev_runtime.jsxDEV(jsx_dev_runtime.Fragment, {
      children: [
        ...
        loggedIn ? jsx_dev_runtime.jsxDEV("button", {
          onClick: (e) => {
            setCart((cart) => {
...
function Cart({
  ...
  const [showCheckout, setShowCheckout] = import_react2.useState(false);
  let count = new Map;
  let total = 0;
  ...
  if (cart.items.length === 0) {
    content = jsx_dev_runtime2.jsxDEV("div", {
      id: "cart-items",
      children: "None"
    }, undefined, false, undefined, this);
  } else {
    content = jsx_dev_runtime2.jsxDEV(jsx_dev_runtime2.Fragment, {
      children: [
        jsx_dev_runtime2.jsxDEV("div", {
          id: "cart-items",
          children: Array.from(count.entries()).map(([product, quantity], i) => {
              ...
              onClick: () => {
                for (let j = 0;j < cart.items.length; j++) {
                  if (cart.items[j] === product) {
                    let newCart = new CartObj(cart.items.slice(0, j).concat(cart.items.slice(j + 1, cart.items.length)));
                    setCart(newCart);
                  }
                }
              },
        ...
        showCheckout ? jsx_dev_runtime2.jsxDEV(Checkout, {
          count,
          setCart,
          setShowCheckout
        }, undefined, false, undefined, this) : jsx_dev_runtime2.jsxDEV("button", {
          onClick: () => {
  ...
  return jsx_dev_runtime2.jsxDEV("div", {
    ...
    children: [
      ...
      jsx_dev_runtime2.jsxDEV("button", {
        onClick: () => {
          fetch("/api/user/logout", { method: "POST" }).then((resp) => {
            if (resp.ok) {
              setLoggedIn(false);
            }
          });
...
var Checkout = function({
  ...
  const [cc, setCc] = import_react2.useState("");
  return jsx_dev_runtime2.jsxDEV("div", {
    id: "checkout",
    children: jsx_dev_runtime2.jsxDEV("form", {
      onSubmit: (e) => {
        e.preventDefault();
        if (!/^\d{15,16}$/.test(cc))
          return;
...
var LoginBar = function({
  ...
  return jsx_dev_runtime3.jsxDEV("div", {
    id: "login-bar",
    children: [
      jsx_dev_runtime3.jsxDEV("h3", {
        children: "Logged out"
      }, undefined, false, undefined, this),
      jsx_dev_runtime3.jsxDEV("form", {
        onSubmit: async function processLogin(e) {
          e.preventDefault();
          let email = document.getElementById("email");
          let password = document.getElementById("password");
          await fetch("/api/user/login?" + new URLSearchParams({
            email: email.value,
...
var Body = function({
  ...
  return jsx_dev_runtime3.jsxDEV("div", {
    id: "body",
    children: jsx_dev_runtime3.jsxDEV(Products, {
      cart,
      setCart,
      loggedIn
    }, undefined, false, undefined, this)
...
function App() {
  const [loggedIn, setLoggedIn] = import_react3.useState(true);
  const [cart, setCart] = import_react3.useState(new CartObj);
  ...
  import_react3.useEffect(() => {
    let login_check = () => {
      ...
      loginCheckInterval = setTimeout(login_check, 15000);
    };
    login_check();
    return () => {
  ...
  return jsx_dev_runtime3.jsxDEV(jsx_dev_runtime3.Fragment, {
    children: [
      jsx_dev_runtime3.jsxDEV("div", {
        id: "side",
        children: loggedIn ? jsx_dev_runtime3.jsxDEV(Cart, {
          cart,
          setCart,
          setLoggedIn
        }, undefined, false, undefined, this) : jsx_dev_runtime3.jsxDEV(LoginBar, {
          setLoggedIn
        }, undefined, false, undefined, this)
      }, undefined, false, undefined, this),
...
var init = function() {
  ...
  root.render(jsx_dev_runtime4.jsxDEV(import_react4.StrictMode, {
    children: jsx_dev_runtime4.jsxDEV(App, {}, undefined, false, undefined, this)
  }, undefined, false, undefined, this));
};
init();
